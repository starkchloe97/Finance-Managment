...
- Prefers one shared set of standardized UI components across modules (search input, filter select, pagination, confirm dialog, loading/empty/error panel) rather than per-page reimplementations of the same pattern. Confidence: 0.8
