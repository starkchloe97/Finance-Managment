  ...
  <div class="form-page">
    <div class="page-head">
      <div>
        ...
        <h1>New customer</h1>
        <p class="page-subtitle">Create a customer profile before building an estimate.</p>
      </div>
    </div>
    ...
    <form class="card form-card" @submit.prevent="submit">
      <section class="form-section">
        <div class="form-section-heading">
          ...
          <p>Keep the contact information your operations team uses to identify the account.</p>
        </div>
        <div class="grid">
          <div class="field">
      ...
      <section class="form-section">
        <div class="form-section-heading">
          ...
          <p>Keep route and account context available for future quotes.</p>
        </div>
        <div class="field">
